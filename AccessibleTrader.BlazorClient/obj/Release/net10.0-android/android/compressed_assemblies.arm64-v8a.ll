...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [268 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		i32 2524672, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 47537376; uint32_t buffer_offset
	}, ; 265: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 22560, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 47708384; uint32_t buffer_offset
	}, ; 266: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2267136, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 47730944; uint32_t buffer_offset
	} ; 267: Mono.Android
], align 4

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 49998080, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [49998080 x i8] zeroinitializer, align 1

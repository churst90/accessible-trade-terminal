...
/// <summary>
/// Custom ContentPage handler for Mac Catalyst that intercepts UIKit PressesBegan
/// and routes hardware keyboard events to IInputService, matching the Android pattern.
/// Registered in MauiProgram.cs via #if MACCATALYST ConfigureMauiHandlers.
/// </summary>
public class KeyboardPageHandler : PageHandler
{
    protected override void ConnectHandler(Microsoft.Maui.Platform.ContentView platformView)
    {
        ...
        // Attempt keyboard controller injection when the native view is first attached.
...
/// events to IInputService.ProcessKey.
/// Uses NSEvent-style Unicode private-use characters for special keys, avoiding
/// UIKeyCommand static property bindings that may not be available in .NET 10.
/// </summary>
internal sealed class KeyboardViewController : UIViewController
{
    // Mac/UIKit special key characters (Unicode private use area)

...
- **Plugins:** `Plugins/` — 28 exchange, data, and analytics provider plugins (14 trading + 14 analytics).
...
- **Tests:** `AccessibleTrader.Tests` — Unit and integration diagnostics (2072 tests, all passing), plus a zero-dependency JS gesture-engine suite (`node tools/jstests/gesture-tests.mjs`, 12 tests). Both run in CI.

...
Suite **6,411** (`--list-tests`
reports 6406, which is the number this file must match and `doc-drift.yml` checks — the two
differ because `--list-tests` names a `[Theory]` once and a run expands its cases), plus
**190** browser tests. **0 CRITICAL and 0 HIGH items open,

...
gated on the current provider having a book. What postdates the tag is under `## [Unreleased]`
in [`CHANGES.md`](CHANGES.md); none of it is in the 2.8.0 binaries.

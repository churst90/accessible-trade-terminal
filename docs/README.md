...
themes that already shipped. Suite 2109 → 2517.
...
- **Tests:** `AccessibleTrader.Tests` — Unit and integration diagnostics (2517 tests, all passing), plus a zero-dependency JS gesture-engine suite (`node tools/jstests/gesture-tests.mjs`, 12 tests). Both run in CI.

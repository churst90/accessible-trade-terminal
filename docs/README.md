...
- **Plugins:** `Plugins/` — 27 exchange, data, and analytics provider plugins (14 trading + 13 analytics).
...
- **Tests:** `AccessibleTrader.Tests` — Unit and integration diagnostics (1526 tests, all passing), plus a zero-dependency JS gesture-engine suite (`node tools/jstests/gesture-tests.mjs`, 12 tests). Both run in CI.

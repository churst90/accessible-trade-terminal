...
then fixing it, in that order. Suite **5,878** in both configurations (`--list-tests` reports 5873,
which is the number this file must match and `doc-drift.yml` checks). CI green on all three

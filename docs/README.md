...
expired key as an account with no balances** (Kraken, Bitstamp, Coinbase, MEXC). Suite **6,007**
in both configurations (`--list-tests` reports 6002, which is the number this file must match and

...
**Error state is conveyed now — it was conveyed nowhere.** The 2026-09-01 accessibility
...
Suite **6,220** (`--list-tests`
reports 6215, which is the number this file must match and `doc-drift.yml` checks — the two
differ because `--list-tests` names a `[Theory]` once and a run expands its cases), plus
**168** browser tests. Eighteen sabotages in this pass, seventeen red — and the one that

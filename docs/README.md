...
Suite 2109 → 2821, plus 15 JS gesture tests.
...
- **Tests:** `AccessibleTrader.Tests` — Unit and integration diagnostics (2821 tests, all passing), plus a zero-dependency JS gesture-engine suite (`node tools/jstests/gesture-tests.mjs`, 12 tests). Both run in CI.

...
themes that already shipped. Suite 2109 → 2484.
...
- **Tests:** `AccessibleTrader.Tests` — Unit and integration diagnostics (2484 tests, all passing), plus a zero-dependency JS gesture-engine suite (`node tools/jstests/gesture-tests.mjs`, 12 tests). Both run in CI.

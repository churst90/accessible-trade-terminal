#!/usr/bin/env python3
"""Disambiguate the THIN catches from the fresh 28-mutant campaign.
...
RESULTS = os.path.join(REPO, "scratchpad", "fresh_sabotage_results.json")
OUT = os.path.join(REPO, "scratchpad", "fresh_disambiguate_results.json")
INFLIGHT = os.path.join(REPO, "scratchpad", "fresh_disambiguate_inflight.txt")

sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
from fresh_sabotage import MUTANTS  # noqa: E402
